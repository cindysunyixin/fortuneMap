function fortune() {
	...
	var map = new google.maps.Map(d3.select("#overlay").node(), {
		zoom: 8,
	...
	// d3.json('../csv/SP500.json', (error, data) => {
        ...
        var displaySuggestions = function(predictions, status) {
	        ...
	        $.ajax({
	        	url: "https://maps.googleapis.com/maps/api/geocode/json?place_id=" + predictions[0].place_id + "&language=en&key=AIzaSyApT24PrB0jOfB23HizzbdiET9ER0zSDCw",
	        	success: (res) => {console.log(res);data[count]['pos'] = res.results[0].geometry.location;
					count = count + 1;
					if (count == 10) {
						console.log("aha");
					}
     ...
     //    (function wait() {
	    ...
	    //     	service.getPlacePredictions({ input: d['Name']}, displaySuggestions);
	    //     	setTimeout( wait, 100 );
		   //    //   $.ajax({
		   //    //   	url: "https://maps.googleapis.com/maps/api/place/autocomplete/json?key=AIzaSyApT24PrB0jOfB23HizzbdiET9ER0zSDCw&input=" + d.Name,
